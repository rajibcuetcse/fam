                ...
                $.each(buttonStr.split(' '), function (i) {
                    ...
                    $.each(this.split(','), function (j, buttonName) {
                        if (buttonName == 'title') {
                            ...
                            if (prevButton) {
                                prevButton.addClass(tm + '<p>fc-header</p>', '-corner-right');
                            }
                            prevButton = null;
                        } else {
                            var buttonClick;
...
// Break the formatting string into an array of chunks
    ...
    function BasicView(element, calendar, viewName) {
        ...
        function buildCellHTML(date) { // date assumed to have stripped time
            ...
            if (showNumbers) {
                html += "<div class='fc-day-number'>" + "<p>" + date.date() + "</p>" + "</div>";
            }
        ...
        function slotSegHtml(event, seg) {
            ...
            html +=
                " class='" + classes.join(' ') + "'" +
                    ...
                    "'" +
                    ">" +
					"<div data-toggle='modal' data-target='#CalendarmyModal1'>" +
...
$(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
        header: {
            ...
            right: 'Display:, month, agendaWeek, today',
            left: ' ,'
        },
        allDaySlot: false,
        ...
        dayClick: function(date, allDay, jsEvent, view) {
            ...
            var title = $.fullCalendar.moment(date).format(longdateFormat);
            $('#CalendarmyModal').modal({
                backdrop: 'static',
                keyboard: false
            });
            $('#MyModalEventdate').html(title);
        ...
        events: [
		{
            "id": "2797",
            "title": "Schedule Two",
			"start": "2015-08-05T11:30:00",
            "end": "2015-08-06T12:30:00",
            "backgroundColor": "#eaeaea",
            "description": "This is Schedule Two"
        },
		{
            "id": "2797",
            "title": "Schedule Three",
			"start": "2015-08-05T12:30:00",
            "end": "2015-08-06T13:30:00",
            "backgroundColor": "#eaeaea",
            "description": "This is Schedule Three"
        },
		{
            "id": "2797",
            "title": "Schedule Four",
			"start": "2015-08-30T11:30:00",
            "end": "2015-08-31T12:30:00",
            "backgroundColor": "#eaeaea",
            "allDay": "",
            "description": "This is Schedule Four"
        },
