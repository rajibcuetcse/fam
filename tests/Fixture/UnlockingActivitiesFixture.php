...
/**
 * UnlockingActivitiesFixture
 *
 */
class UnlockingActivitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '1=unlocked by tokens, 2= unlocked by tickets', 'precision' => null, 'autoIncrement' => null],
        'status' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '1=unlocked,2=paid,3=expired', 'precision' => null],
        '_constraints' => [
