...
class UsergroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'group_name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'usergroups_ibfk_1' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companies', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created_on' => 1447364779,
            'modified_on' => 1447364779,
            'status' => 1,
            'company_id' => 1
        ],
    ];
