...
class CmsusersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'language' => ['type' => 'string', 'length' => 2, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'reset_password_token' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'reset_password_token' => 'Lorem ipsum dolor ',
            'created_on' => 1447079320,
            'updated_on' => 1447079320,
            'status' => 1,
            'company_id' => 1
        ],
    ];
