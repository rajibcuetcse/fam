...
//            'upload_url' => Router::url('/').'img/',
        //'http://localhost/zeerowapp_cms/'.'contents'.'/'.'addUpload/'
        
        $this->options = array(
            'script_url' => Router::url(["controller" => "contents","action" => "addUpload"]),
...
//    }
    ...
    public function get_unique_filename($file_path, $name, $size, $type, $error,
            $index, $content_range) {
    ...
    public function fix_file_extension($file_path, $name, $size, $type, $error,
            $index, $content_range) {
    ...
    public function trim_file_name($file_path, $name, $size, $type, $error,
            $index, $content_range) {
