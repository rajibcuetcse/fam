<?= $this->element('user_management_nav', array('title' => __('Add User'), 'permissions' => $user_permission,
            ...
            <div class="col-md-6">
             <?= $this->Form->create($cmsuser,array('enctype'=>'multipart/form-data')) ?>
              <div class="form-group">
            	<?php echo $this->Form->input('language', array('options' => $languages, 'class'=>'form-control'));?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
              ...
              <!-- /.form-group -->
              <div class="form-group">
                <?php echo $this->Form->password('retype_password', array('id' => 'retype_password', 'class' => 'form-control required', 'placeholder' => __('Retype Password')));?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
