<?= $this->element('user_management_nav', array('title' => __('User Management'), 'permissions' => $user_permission,
    'showNavigationButtons' => true/*, 'submodule' => SubModuleConstants::USER_MANAGEMENT*/)); ?>
<?php 
				...
				<div class="row">
                            <?php
									...
									$page_id = $module_pages ["delete"];
										...
										?>
                                         <?= $this->Form->create(null, ['url' => ['controller' => 'users', 'action' => 'bulkAction']]); ?>
				...
				<div class="col-md-6">
                       ...
                       <div class="box-tools">
                           ...
                           <div class="input-group-btn">
                                    <?=$this->Form->submit ( __ ( 'User Search' ), [ 'class' => 'btn btn-success btn-flat' ] );?>
                                </div>
									</div>
								</div>
                        </div>
                                ...
                                <?php foreach ($cmsusers as $cmsuser): ?>
                                    <tr>
                                        <td>
                                            <div> <!-- <div class="checkbox"> -->
                                                <input type="checkbox" 
                                                         id="content_<?= $cmsuser->id ?>">
                                                <label class="image-checkbox-label"
                                                       for="content_<?= $cmsuser->id ?>"></label>
                                            </div>
                                        </td>

                                        <td><?= h($cmsuser->username) ?></td>
                                        <td>  <?= h($cmsuser->email) ?></td>
                                        <td> <?= h($cmsuser->created_on) ?></td>
                                                    ...
                                                    foreach ($user_permission as $permission) {
                                                        ...
                                                        if ($permission['page_id'] == $page_list['edit'] && !in_array($page_list['edit'], $added)) {
                                                            ...
                                                            <li>
                                                                ...
                                                                <?= $this->Html->link('<i class="fa fa-pencil"></i>'.__('Edit'), '/users/edit/' . $cmsuser->id,array('escape'=>false)) ?>
                                                            </li>
                                                            <?php
                                                           ...
                                                           <li>
                                                                ...
                                                                <?= $this->Form->postLink(' <i class="fa fa-trash-o"></i>'.__('Delete'), ['action' => 'delete', $cmsuser->id], ['confirm' => __('Are you sure you want to delete {0}?', $cmsuser->username),'escape'=>false]) ?>
                                                            </li>
                                                            <?php
                                                        } elseif ($permission['page_id'] == $page_list['view'] && !in_array($page_list['view'], $added)) {
                                                            array_push($added, $page_list['view']); ?>
                                                           <li>
                                                               
                                                                <?= $this->Html->link('<i class="fa fa-list-alt"></i>'.__('View'), '/users/view/' . $cmsuser->id,array('escape'=>false)) ?>
                                                            </li>
                                                            <?php
                                                        }
                                                    } ?>
