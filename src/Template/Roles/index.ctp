<?= $this->element('user_management_nav', array('title' => __('Role Management'), 'permissions' => $user_permission,
				...
				<div class="row">
                            <?php
									...
									$page_id = $module_pages ["delete"];
										...
										?>
                                         <?= $this->Form->create(null, ['url' => ['controller' => 'roles', 'action' => 'bulkAction']]); ?>
				...
				<div class="col-md-6">
                       ...
                       <div class="box-tools">
                           ...
                           <div class="input-group-btn">
                                    <?=$this->Form->submit ( __ ( 'Search Role' ), [ 'class' => 'btn btn-success btn-flat' ] );?>
                                </div>
									</div>
								</div>
                        </div>
                                                    ...
                                                    foreach ($user_permission as $permission) {
                                                        ...
                                                        if ($permission['page_id'] == $page_list['edit'] && !in_array($page_list['edit'], $added)) {
                                                            ...
                                                            <li>
                                                                ...
                                                                <?= $this->Html->link('<i class="fa fa-pencil"></i>'.__('Edit'), '/roles/edit/' . $role->id,array('escape'=>false)) ?>
                                                            </li>
                                                            <?php
                                                           ...
                                                           <li>
                                                                ...
                                                                <?= $this->Form->postLink(' <i class="fa fa-trash-o"></i>'.__('Delete'), ['action' => 'delete', $role->id], ['confirm' => __('Are you sure you want to delete {0}?', $role->title),'escape'=>false]) ?>
                                                            </li>               
                                                            <?php
                                                        }
                                                    } ?>
