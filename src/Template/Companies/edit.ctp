          ...
          <div class="row">
            <div class="col-md-6">
             ...
             <ul class="nav nav-tabs">
              ...
              <!-- /.form-group -->
              <div class="form-group">
                <?php echo $this->Form->input('company.address2', ['label' => __('ADDRESS_TWO'), 'class' => 'form-control', 'required' => false, 'value' => $company['address2']]); ?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
              ...
              <ul class="list-unstyled uploaded_files">
                  <?php echo $this->Form->input('uploaded_file', ['type' => 'hidden', 'class' => 'upload_file', 'name' => 'uploaded_file', 'value' => $company['logo']]) ?>
              </ul>
              <p style="width:100px;">
            ...
            <div id="super_admin_div" class="hide">
             <div class="form-group">
                <?php echo $this->Form->input('cmsuser.language', ['options' => $languages, 'label' => __('LANGUAGE'), 'class' => 'form-control required', 'value' => $cmsuser['language']]); ?>
              </div>
              <!-- /.form-group -->
               <div class="form-group">
...
<script>
    ...
    function checkRetypePassword(input) {
        if (input.value != document.getElementById('cmsuser-password').value) {
    ...
    function checkPassword(input) {
        if (input.value != document.getElementById('retype_password').value) {
            input.setCustomValidity('The two passwords must match.');
        } else {
            // input is valid -- reset the error message
            input.setCustomValidity('');
