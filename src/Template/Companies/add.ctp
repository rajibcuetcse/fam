...
<?php echo $this->Form->input('company.name', ['label' => ['class' => 'required','text' => __('COMPANY_NAME') ], 'class' => 'form-control', 'required' => true, 'error' => ['Please fill out this field.' => __('ENTER_COMPANY_NAME')]]); ?>
                        </div>   
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.cname', ['label' => ['class' => 'required','text' => __('CONTACT_NAME')], 'class' => 'form-control required', 'required' => true, 'error' => ['Please fill out this field.' => __('ENTER_CONATACT_NAME')]]); ?>
                        </div>   
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.cemail', ['label' => ['class' => 'required','text' => __('CONTACT_EMAIL')], 'class' => 'form-control required', 'required' => true, 'error' => ['Please fill out this field.' => __('ENTER_CONATACT_EMAIL')]]); ?>
                        </div>  
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.address1', ['label' => ['class' => 'required','text' => __('ADDRESS_ONE')], 'class' => 'form-control required', 'error' => __('ENTER_ADDRESS')]); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.address2', ['label' => __('ADDRESS_TWO'), 'required' => false, 'class' => 'form-control']); ?>
                        ...
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.city', ['label' => ['class' => 'required','text' => __('CITY')], 'class' => 'form-control required']); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.state', ['label' => ['class' => 'required','text' => __('STATE')], 'class' => 'form-control required']); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.country', ['label' => ['class' => 'required','text' => __('COUNTRY')],'empty' => __('SELECT_COUNTRY'), 'options' => $countries, 'class' => 'form-control required']); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.confederation', ['label' => ['class' => 'required'],'empty' => __('SELECT_FA_CONFEDERATION'), 'options' => json_decode(FA_CONFEDERATION), 'class' => 'form-control required']); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.postcode', ['label' => ['class' => 'required','text' => __('POSTCODE')], 'class' => 'form-control required']); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.general_secretary', ['label' => ['class' => 'required','text' => __('FA_GENERAL_SECRETARY')], 'required' => true, 'class' => 'form-control required']); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
...
<?php echo $this->Form->input('company.registration_no', ['type' => 'hidden', 'label' => __('Tax/Registration Number'), 'class' => 'form-control', 'min' => 0]); ?>
                        ...
                        <!-- /.form-group -->
                        <div class="form-group">
<?php echo $this->Form->input('company.ranking_w', ['type' => 'number', 'label' => ['class' => 'required','text' => __('RANK_W')], 'required' => true,'error' => ['Please fill out this field.' => __('ENTER_CONATACT_NAME')], 'class' => 'form-control required', 'min' => 0]); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
    <?php echo $this->Form->input('company.ranking_m', ['type' => 'number', 'label' => ['class' => 'required','text' => __('RANK_M')], 'required' => true,'error' => ['Please fill out this field.' => __('ENTER_CONATACT_NAME')], 'class' => 'form-control required', 'min' => 0]); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
    <?php echo $this->Form->input('company.timezone', ['label' => ['class' => 'required', 'text' => __('Time Zone')],'empty' => __('Select Time Zone'), 'options' => $timezones , 'class' => 'form-control', 'required' => true]); ?>
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
    <?php echo $this->Form->input('company.logo', ['type' => 'file', 'label' => ['class' => 'required','text' => __('Corporate Logo')], 'data-toggle' => 'modal', 'data-target' => '#myModal-3', 'required' => true]); ?>
                        </div>
                        <!-- /.form-group -->
...
<?php echo $this->Form->input('cmsuser.username', ['label' => ['class' => 'required','text' => __('USERNAME')], 'class' => 'form-control required', 'required' => true]); ?>
                    ...
                    <!-- /.form-group -->
                    <div class="form-group">
<?php echo $this->Form->input('cmsuser.password', ['label' => ['class' => 'required','text' => __('PASSWORD')], 'class' => 'form-control required', 'required' => true]); ?>
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
