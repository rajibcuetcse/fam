<?= $this->element('user_management_nav', array('title' => __('Edit User Group'), 'permissions' => $user_permission,
            ...
            <div class="col-md-6">
             <?= $this->Form->create($usergroup) ?>
              <div class="form-group">
            	<?php echo $this->Form->input('group_name', array('class' => 'form-control required', 'placeholder' => __('Group Name')));?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
