...
<div class="row">
		...
		<div class="col-md-6">
			<h3 class="box-title no-margin"><span class="glyphicon glyphicon-file"></span>Add Module</h3>
		</div>
            ...
            <div class="col-md-6">
             <?= $this->Form->create($newmodule) ?>
              ...
              <div class="form-group">
            	<?php echo $this->Form->input('id', ['label' => __('MODULE_ID'), 'class' => 'form-control', 'required' => true, 'error' => false,'type' => 'text','placeholder'=>'Module Id']);?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
                <?php echo $this->Form->input('name', ['label' => __('MODULE_NAME'), 'class' => 'form-control', 'required' => true, 'error' => false,'placeholder'=>'Module Name']);?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
                <?php echo $this->Form->input('icon', ['label' => __('Module Icon'), 'class' => 'form-control', 'required' => true, 'error' => false,'placeholder'=>'Module Icon']);?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
