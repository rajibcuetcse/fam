...
<div class="row">
		...
		<div class="col-md-6">
			<h3 class="box-title no-margin"><span class="glyphicon glyphicon-file"></span>Pages</h3>
		</div>
                    ...
                    if (array_key_exists("add", $module_pages)):
                        ...
                        foreach ($user_permission as $permission):
                            if ($permission['page_id'] == $page_id):?>
                                    ...
                                    <a href="<?php echo $this->Url->build('/pages/add/'); ?>"  class="btn btn-success btn-flat btn-grid">
                                        <i class="fa fa-plus-square"></i>
                                        <?php echo __('ADD_PAGE'); ?>
                                    </a>
                            ...
                            <?php
									...
									$page_id = $module_pages ["delete"];
										foreach ( $user_permission as $permission ) :
											if ($permission ['page_id'] == $page_id) :
										?>
                                        <?= $this->Form->create(null, ['url' => ['controller' => 'pages', 'action' => 'bulkAction']]); ?>
				...
				<div class="col-md-6">
                       ...
                       <div class="box-tools">
                           ...
                           <div class="input-group-btn">
                                    <?=$this->Form->submit ( __ ( 'SEARCH_PAGE' ), [ 'class' => 'btn btn-success btn-flat' ] );?>
                                </div>
									</div>
								</div>
                        </div>
            ...
            <div class="box-body table-responsive ">
              <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting_asc"><?= $this->Paginator->sort('Pages.id', ['value' => __('PAGE_ID')]) ?></th>
                                    ...
                                    <th><?= $this->Paginator->sort('Pages.name', ['value' => __('PAGE_NAME')]) ?></th>
                                    <th>
                                        <?= $this->Paginator->sort('Pages.created_on', ['value' => __('CREATED_ON')]) ?>
                                    </th>

                                    <th>
                                        <?= $this->Paginator->sort('Pages.modified_on', ['value' => __('MODIFIED_ON')]) ?>
                                    </th>
                                        ...
                                        <td>
                                            <div> <!-- <div class="checkbox"> -->
                                                ...
                                                <label class="image-checkbox-label"
                                                       for="content_<?= $page->id ?>"></label>
                                            </div>
                                        </td>

                                        <td><?= $page->id ?></td>
                                        <td><?= $page->sub_module->module->name ?></td>
                                        <td><?= $page->sub_module->name ?></td>
                    ...
                    <li>
                     <?php
                                                    if (array_key_exists("edit", $module_pages)):
                                                        ...
                                                        foreach ($user_permission as $permission):
                                                            if ($permission['page_id'] == $page_id):?>
                                                                <a href="   <?php echo $this->Url->build(['action' => 'edit', $page->id]) ?>"><i class="fa fa-pencil"></i><?php echo __('EDIT') ?>
                                                                </a>
                                                                <?php
                                                                break;
                                                            endif;
                                                    ...
                                                    if (array_key_exists("delete", $module_pages)):
                                                        ...
                                                        foreach ($user_permission as $permission):
                                                            if ($permission['page_id'] == $page_id):?>
                                                                        ...
                                                                        <?php echo $this->Form->postLink(' <i class="fa fa-trash-o"></i>'.__('DELETE'), ['action' => 'delete', $page->id], ['confirm' => __('Are you sure you want to delete {0}?', $page->name),'escape'=>false]) ?>
...
<script>
    ...
    $(document).ready(function () {
        $(document).on('click', '.edit', function () {
            ...
            window.location = '<?php echo $this->Url->build('/pages/edit/');?>' + cid;
            return false;
        });
