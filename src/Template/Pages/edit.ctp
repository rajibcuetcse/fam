...
<div class="row">
		...
		<div class="col-md-6">
			<h3 class="box-title no-margin"><span class="glyphicon glyphicon-file"></span>Edit Page</h3>
		</div>
            ...
            <div class="col-md-6">
             <?= $this->Form->create($page) ?>
              <div class="form-group">
            	<?php echo $this->Form->input('id', ['label' => __('PAGE_ID'), 'class' => 'form-control', 'required' => true, 'error' => false,'type' => 'text']);?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
                <?php echo $this->Form->input('module_id', ['empty' => __('Select a module'), 'id' => 'module_id', 'options' => $modules, 'label' => __('MODULE_NAME'), 'class' => 'form-control', 'required' => true]);?>
              </div>
              <!-- /.form-group -->
              <span>
              ...
              <div class="form-group">
                <?php echo $this->Form->input('sub_module_id', ['empty' => __('Select a Submodule'), 'id' => 'sub_module_id', 'label' => __('SUB_MODULE_NAME'), 'class' => 'form-control', 'required' => true]);?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
                <?php echo $this->Form->input('name', ['label' => __('PAGE_NAME'), 'class' => 'form-control', 'required' => true]);?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
              ...
              <div class="checkbox">
              	<label>
                    <input type="checkbox" id="available-to-company" name="available_to_company" <?php echo $page['available_to_company'] != 0 ? " checked=\"checked\"" : ""; ?>>
